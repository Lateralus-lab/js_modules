...
const outSevenOne = document.querySelector('.out-71');
const outSevenTwo = document.querySelector('.out-72');

function f7() {
    const sumSeven = inputSeven.value;

    if (sumSeven.length >= 6) {
        outSevenOne.innerHTML = sumSeven;
        outSevenTwo.innerHTML = '1';
    } else {
        outSevenOne.innerHTML = sumSeven;
    }
}
...
function f8() {
    outEight.innerHTML += '<input class="i-81" type="text">';
    outEight.innerHTML += '<button class="b-81">Push me</button>';
    outEight.innerHTML += '<div class="out-81"></div>';

    const inputEight = document.querySelector('.i-81');
    const buttonEight = document.querySelector('.b-81');
    const outEightTwo = document.querySelector('.out-81');

    buttonEight.onclick = () => {
        outEightTwo.innerHTML = inputEight.value;
    }
}
...
const inputNine = document.querySelector('.r-9');
const outNine = document.querySelector('.out-9');

function f9() {
    if (inputNine.checked) {
        outNine.innerHTML = inputNine.value;
...
const inputTen = document.querySelector('.i-10');
const outTen = document.querySelector('.out-10');

function f10() {
    outTen.style.color = inputTen.value;
}
...
const inputElevenOne = document.querySelector('.i-111');
const inputElevenTwo = document.querySelector('.i-112');
...
const outTwelve = document.querySelector('.out-12');

function f12() {
    outTwelve.innerHTML = inputTwelve.value;
}
...
const outThirteen = document.querySelector('.out-13');

function f13() {
    outThirteen.innerHTML = document.querySelector('.i-13').value;
}
...
const textFourteen = document.querySelector('.t-14');
const outFourteen = document.querySelector('.out-14');

function f14() {
    outFourteen.innerHTML = textFourteen.value;
}
...
const inputFithteen = document.querySelector('.i-15');
const textFithteen = document.querySelector('.t-15');
const outFithteen = document.querySelector('.out-15');

function f15() {
    textFithteen.innerHTML = inputFithteen.value;
    outFithteen.innerHTML = inputFithteen.value;
}
...
const outSixteen = document.querySelector('.out-16');
const selectSixteen = document.querySelector('.s-16');

function f16() {
    if (selectSixteen.value == 'one') {
        outSixteen.innerHTML = '1';
    } else if (selectSixteen.value == 'two') {
        outSixteen.innerHTML = '2';
    } else {
        outSixteen.innerHTML = '5';
    }
}
...
const selectSeventeen = document.querySelector('.s-17');
const outSeventeen = document.querySelector('.out-17');

function f17() {
    outSeventeen.innerHTML = selectSeventeen.value;
}
...
const selectEighteen = document.querySelector('.s-18');
const inputEighteen = document.querySelector('.i-18');

function f18() {
    inputEighteen.value = selectEighteen.value;
}
...
const inputNineteenOne = document.querySelector('.i-191');
const inputNineteenTwo = document.querySelector('.i-192');
const outNineteen = document.querySelector('.out-19');

function f19() {
    outNineteen.innerHTML = inputNineteenOne.value + ' ' + inputNineteenTwo.value;
}
...
const formTwenty = document.querySelector('.f-20');
const outTwenty = document.querySelector('.out-20');
...
function f20(e) {
    ...
    inputName = form.elements['username'].value;
    inputPass = form.elements['password'].value;

    outTwenty.innerHTML = inputName + ' ' + inputPass;
