...
let ar3 = ['Eli', 29, 10, 'random'];
const outThree = document.querySelector('.out-3');

function f3() {
    outThree.textContent = ar3.length;
}
...
let ar4 = ['koan', 100, 'cryptic', 'mind', 80, 'tool', 'key', true, 'lateralus', 'pneuma'];
const outFour = document.querySelector('.out-4');

function f4() {
    outFour.textContent += ar4[0] + ' ' + ar4[3] + ' ' + ar4[8];
}
...
function f5() {
    outFive.textContent += ar5[0] + ar5[2] + ar5[3];
}
...
function f12() {
    ...
    ar12[ar12.length - 1] = a0;

    let out = '';
    for (i = 0; i < ar12.length - 1; i++) {
        out = ar12.join(' ');
    }
...
function f18() {
    document.querySelector('.out-18').textContent = Math.max.apply(Math, ar18);
}
...
function f19() {
    document.querySelector('.out-19').textContent = Math.min.apply(Math, ar19);
}
...
let reducer = (sumOne, sumTwo) => sumOne + sumTwo;

function f20() {
    document.querySelector('.out-20').textContent = ar20.reduce(reducer);
}
