...
document.querySelector('.one').innerHTML = 'Helo world';
...
document.querySelector('.three').innerHTML = '<h3>Тут произвольный текст</h3>'
...
document.querySelector('.four').innerHTML = '<h3>Произвольный текст</h3>' + '<p>Произвольный текст</p>';
...
let z1 = 6, z2 = 3;
total_z = 6 * 3;
document.querySelector('.out-14').innerHTML = total_z;
...
let y1 = 6, y2 = 3;
total_y = y1 / y2;
document.querySelector('.task15').innerHTML = total_y;
...
let x1 = 'Hello', x2 = 5;
total_x = x1 + x2;
document.querySelector('.task16').innerHTML = total_x;
...
let divS3 = document.querySelector('.s3', '.s4');
console.log('divS3');
